...
Queue will need to have the following functionality:
    ...
    front - returns the element at the front of the queue
            front advances to the next position in the queue as items are removed
...
class Queue:
    def __init__(self, initial_size = 10):
        ...
        self.next_index = 0 # next free slot in array
        self.front_index = -1 # -1 indicates empty
        self.queue_size = 0
    ...
    def enqueue(self, value):
        ...
        self.queue_size += 1
        # allows queue to wrap around and use a free slot
        # assumes items at front of queue were already dequeued
    ...
    def dequeue(self):
        ...
        # move front index to pt to the next available item
        # modulo allows for wrap around reuse of space in queue
    ...
    def front(self):
        ...
        # (whatever item is located at the front_index position).
