...
"""
Reverse a Stack (in-place reversal)
...
test_case_3 = [99, 17, 33, 1, 11, 0, -11, 209, 99]
...
print("stacked in original order...")
print(stacked.printNodes())

reverse_stack(stacked)

print("\nsize of stacked =", stacked.size())
print("stacked in reverse order...")
print(stacked.printNodes())
